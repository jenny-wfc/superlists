...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    #     )
    #
    #     # She types "Buy peacock feathers" into a text box (Michelle's hobby
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        # Michelle starts a new to-do list
        self.browser.get(self.live_server_url)
        inputbox = self.browser.find_element_by_id('id_new_item')
        inputbox.send_keys('Buy peacock feathers')
        inputbox.send_keys(Keys.ENTER)
        ...
        michelle_list_url = self.browser.current_url
        self.assertRegex(michelle_list_url, '/lists/.+')

        # Now a new user, Bob, comes along to the site.

        ## We use a new browser session to make sure that no information
        ## of Michelle's is coming through from cookies etc
        self.browser.quit()
        self.browser = webdriver.Firefox()

        # Bob visits the home page. There is no sign of Michelle's list
        self.browser.get(self.live_server_url)
        page_text = self.browser.find_element_by_tag_name('body').text
        self.assertNotIn('Buy peacock feathers', page_text)
        self.assertNotIn('make a fly', page_text)

        # Bob starts a new list by entering a nwe item. He
        ...
        self.assertNotEqual(bob_list_url, michelle_list_url)

        # Again, there is no trace of Michell's list
        page_text = self.browser.find_element_by_tag_name('body').text
        self.assertNotIn('Buy peacock feathers', page_text)
    ...
    def test_layout_and_styling(self):
        # Michelle goes to the home page
        self.browser.get(self.live_server_url)
